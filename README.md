<!DOCTYPE html>
<!-- saved from url=(0061)https://ldtax.gov.bd/dakhila/QkwxSGFsNGsrelB1UVZmRnYxczFMZz09 -->
<html lang="en"><!--<![endif]--><!-- BEGIN HEAD --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 <title> ভূমি উন্নয়ন কর সিস্টেম অটোমেশন:
        LdtaxHoldings</title>
...
<link href="./NRRT09_files/css" rel="stylesheet" type="text/css">
<link href="./NRRT09_files/font-awesome.min.css" rel="stylesheet" type="text/css">
<link href="./NRRT09_files/simple-line-icons.min.css" rel="stylesheet" type="text/css">
<link href="./NRRT09_files/bootstrap.min.css" rel="stylesheet" type="text/css">
...
<link href="./NRRT09_files/bootstrap-switch.min.css" rel="stylesheet" type="text/css">

<link href="./NRRT09_files/components-rounded.css" id="style_components" rel="stylesheet" type="text/css">

<!-- remove checkbox add.ctp -->
<!-- <link href="https://ldtax.gov.bd/assets/global/css/plugins-md.css" rel="stylesheet" type="text/css"/> -->
<link href="./NRRT09_files/layout.css" rel="stylesheet" type="text/css">
<link href="./NRRT09_files/light.css" rel="stylesheet" type="text/css" id="style_color">
<link href="./NRRT09_files/custom.css" rel="stylesheet" type="text/css">
<link href="./NRRT09_files/common.css" rel="stylesheet" type="text/css">
<link href="./NRRT09_files/custom(1).css" rel="stylesheet" type="text/css">

<link rel="stylesheet" href="./NRRT09_files/select2.min.css">

            <link rel="shortcut icon" href="https://ldtax.gov.bd/img/favicon.ico">
<script src="./NRRT09_files/jquery.js.download"></script>
<style type="text/css">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            ...
            <a href="https://office.land.gov.bd/"> 
                <img src="./NRRT09_files/logo-light.png" alt="logo" class="logo-default">
            </a>
                    </div>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="separator hide">
                                        ...
                                        <img src="./NRRT09_files/nagorik.png">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="tools" style="display: none;">
                    ...
                    <a href="https://ldtax.gov.bd/dakhila/QkwxSGFsNGsrelB1UVZmRnYxczFMZz09#portlet-config" data-toggle="modal" class="config" data-original-title="" title="">
                    </a>
                    ...
                    <div class="col-md-12">
                        <style type="text/css">
                            ...
                            .qrcode-print{
                               width:100%;
                               display: list-item;
                               list-style-image: url(data:image/png;base64,);
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="from-controll">
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right input_bangla">ক্রমিক নং ২৬২৬২৩০৪৩৫৫১</td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table style="width:100%;">
                                            <tbody><tr>
                                                ...
                                                <td class="dotted_botton">ক্যান্টনমেন্ট ভূমি অফিস</td>
                                            </tr>
                                        </tbody></table>
                                        <table style="margin-top:5px; width:100%;">
                                            <tbody><tr>
                                                <td style="width: 140px;">মৌজার ও জে. এল. নং:</td>
                                                <td class="dotted_botton input_bangla" style="padding: 0 10px 0 5px;">জোয়ার সাহারা - ৩</td>
                                                <td style="width: 105px">উপজেলা / থানা  :</td>
                                                <td class="dotted_botton" style="padding: 0 10px 0 5px;">ক্যান্টনমেন্ট</td>
                                                <td style="width: 40px">জেলা:</td>
                                                <td class="dotted_botton" style="padding: 0 10px 0 5px;">ঢাকা</td>
                                            </tr>
                                        </tbody></table>
                                    ...
                                    <div class="from-controll">
                                        ...
                                        <tbody style="height: 11px;">
                                                                                <tr>
                                                <td class="b1 input_bangla">১</td>
                                                <td class="b1 input_bangla">মোঃ আবুল কালাম আজাদ গং</td>
                                                <td class="b1 input_bangla text-right">১</td>
                                            </tr>
                                                                            </tbody>
                                    </table>
                                        ...
                                        <tbody style="height: 21px;">
                                                                                <tr>
                                                <td class="b1 input_bangla">১</td>
                                                <td class="b1 input_bangla">৪৩৫০১</td>
                                                <td class="b1">
                                                    ডোবা(                                                    আবাসিক)                                                </td>
                                                <td class="b1 input_bangla">২২.২৪২৩৪</td>
                                            </tr>
                                                                            </tbody>
                                    </table>
                                    ...
                                    <table style="border: 1px dotted; border-collapse: collapse; margin:10px 2px ; width: 100%; font-size: 12px;">
                                        <tbody><tr>
                                            ...
                                            <td class="b1 input_bangla" style="width: 50%;">২২.২৪২৩৪</td>
                                        </tr>
                                    </tbody></table>
                                    <div style="height: 10px;"></div>
                                    ...
                                    <div style="width:100% !important; margin:10px 2px ;">
                                        <p class="dotted_botton"> সর্বমোট (কথায়):
                                                                                        এক হাজার তিন শত আশি টাকা মাত্র ।
                                        </p>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div style="width: 330px; float: left;" align="left">
                                                <p style="margin: 0 !important;"></p><p style="margin: 0 !important;">নোট: সর্বশেষ কর পরিশোধের সাল - ১৪৩০</p><p></p>
                                                <p class="input_bangla"> চালান নং : </p>
                                                <p>
                                                    তারিখ : </p><div style="margin-top: -37px;margin-left: 10px;"><p style="width: 115px;padding: 0;margin: 0;margin-left: 38px;margin-bottom: 2px;">১০ মাঘ ১৪৩০</p><span style="border-top:1px solid; margin-left:36px;">২৪ জানুয়ারী ২০২৪</span><p></p></div>
                                                <p></p>
                                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="text-align: center !important; display: block !important;">
                            ...
                            <!-- <a class="btn btn-md btn-success" href="https://ldtax.gov.bd/ldtax-holdings/individual-rashid-print-offline-preview/QkwxSGFsNGsrelB1UVZmRnYxczFMZz09" target="_blank" style="margin-top: 10px;padding:10px;">PDF</a> -->
                        </div>
                    </div>
                </div>
            </div>
...
<div class="page-footer">
	...
	<img src="./NRRT09_files/bd.png" alt="">
...
<!--   <a href="http://www.a2i.pmo.gov.bd/" target="_blank">
    ...
    <div class="page-footer-inner pull-right">
        ...
        <a href="http://mysoftheaven.com/" target="_blank">
	        <img src="./NRRT09_files/auto.png" alt="" style="width: 140px;">
	    </a>
        &nbsp;&nbsp;
	</div>
</div>
...
<![endif]-->
<script src="./NRRT09_files/jquery.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/jquery-migrate.min.js.download" type="text/javascript"></script>
<!-- IMPORTANT! Load jquery-ui.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
<script src="./NRRT09_files/jquery-ui.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/bootstrap.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/bootstrap-hover-dropdown.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/jquery.slimscroll.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/jquery.blockui.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/jquery.cokie.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/jquery.uniform.min.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/bootstrap-switch.min.js.download" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
<!-- Latest compiled JavaScript -->
<script src="./NRRT09_files/select2.min.js.download"></script>


<script src="./NRRT09_files/jquery.validate.js.download"></script>


<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="./NRRT09_files/jquery.notific8.min.js.download"></script>
<script src="./NRRT09_files/toastr.min.js.download"></script>
<script src="./NRRT09_files/metronic.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/layout.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/demo.js.download" type="text/javascript"></script>
<script src="./NRRT09_files/style.js.download"></script>
<!--<script src="https://ldtax.gov.bd/assets/admin/pages/scripts/charts-amcharts.js"></script>-->
<script src="./NRRT09_files/jquery.slimscroll.min(1).js.download" integrity="sha512-cJMgI2OtiquRH4L9u+WQW+mz828vmdp9ljOcm/vKTQ7+ydQUktrPVewlykMgozPP+NUBbHdeifE6iJ6UVjNw5Q==" crossorigin="anonymous"></script>

<script src="./NRRT09_files/jquery.form.min.js.download"></script><script src="./NRRT09_files/jquery.jqprint-0.3.js.download"></script><script src="./NRRT09_files/application_receipt.js.download"></script><script src="./NRRT09_files/tinymce.min.js.download"></script>
<script>
...
<script async="" src="./NRRT09_files/js"></script>
<script>
